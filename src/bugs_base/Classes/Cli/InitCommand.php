        ...
        $dh->start([
            'tt_content' => [
                'NEW123' => [
                    ...
                    'CType' => 'text',
                    'bodytext' => <<<HTML
<p>With RTE config minimal the custom-element tag should be escaped:</p>

<custom-element>Foo</custom-element>
HTML
,
                    'bodytext2' => <<<HTML
<p>With RTE config minimal-plus the custom-element tag should be allowed:</p>
